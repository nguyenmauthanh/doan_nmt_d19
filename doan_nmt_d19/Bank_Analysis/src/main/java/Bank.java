...
public class Bank {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataStream < AlarmedCustomer > alarmedCustomers = env.readTextFile("/home/thanhnm95/alarmed_cust.txt")
        ...
        DataStream < LostCard > lostCards = env.readTextFile("/home/thanhnm95/lost_cards.txt")
        ...
        AllFlaggedTxn.addSink(StreamingFileSink
                .forRowFormat(new Path("/home/thanhnm95/flagged_transaction"),
