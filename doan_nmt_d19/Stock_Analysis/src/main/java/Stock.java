...
public class Stock {
    public static void main(String[] args) throws Exception {
        ...
        DataStream < Tuple5 < String, String, String, Double, Integer >> data = env.readTextFile("/home/thanhnm95/FUTURES_TRADES.txt")
        ...
        change.addSink(StreamingFileSink
                .forRowFormat(new Path("/home/thanhnm95/Ist report.txt"),
        ...
        largeDelta.addSink(StreamingFileSink
                .forRowFormat(new Path("/home/thanhnm95/Alert.txt"),
                        new SimpleStringEncoder < String > ("UTF-8"))
                .withRollingPolicy(DefaultRollingPolicy.builder().build())
                .build());
